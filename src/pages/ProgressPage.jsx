  ...
  return (
    <div className="newgoal my-[48px] mx-[100px] flex items-start gap-5">
      <form className="new-forms text-left">
        ...
        <div className="uper-form mt-6 w-[656px] mb-[50px] flex flex-col items-start gap-4">
          <div className="goal-t mb-4 flex flex-col items-start gap-3">
          ...
          <div className="goal-d flex flex-col items-start gap-3">
        ...
        <div className="lower-form flex flex-col items-start w-[656px] bg-[#0585cd29] p-[60px_50px] gap-[66px]">
          ...
          <div className="progress w-[368px] flex flex-col items-start gap-3">
            ...
            <div className="loader-con bg-[#d9d9d9] w-full h-3 rounded-[10px]">
              <div className="loader-bar h-3 rounded-[10px] bg-[#ff0000cc] w-[30%]"></div>
            </div>
          </div>

          <button className="bg-[#0585cd] px-4 py-4 rounded-[10px] text-white font-semibold text-xl cursor-pointer">
            Update Progress
          </button>
        </div>
      </form>
